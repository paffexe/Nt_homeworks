...
exports.DeliveryMethodService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const delivery_method_entity_1 = require("./schemas/delivery_method.entity");
let DeliveryMethodService = class DeliveryMethodService {
    deliveryMethodSchema;
    constructor(deliveryMethodSchema) {
        this.deliveryMethodSchema = deliveryMethodSchema;
    }
    async create(createDeliveryMethodDto) {
...
exports.DeliveryMethodService = DeliveryMethodService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(delivery_method_entity_1.DeliveryMethod.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], DeliveryMethodService);
//# sourceMappingURL=delivery_method.service.js.map